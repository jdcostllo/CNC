...
The TMC2208 driver has a library within the Arduino IDE with provided examples. Version 0.2.5 is latest at time of this README. The INO file `TMC2208_Example` is a modified version of the example code from the TMC2208 Arduino Library.
